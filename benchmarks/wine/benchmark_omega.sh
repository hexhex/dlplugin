...
do
	...
	do
		...
		redwine(X) :- wine(X), &dlC[\"wine.rdf\", whitewine, mcdry, empty, empty, \"http://www.w3.org/TR/2003/PR-owl-guide-20031209/wine#RedWine\"](X)<fullylinear>.

		inconsistent :- not &dlConsistent[\"wine.rdf\", whitewine, mcdry, empty, empty]().
		:- inconsistent.
		" > prog.hex
