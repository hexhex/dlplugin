...
#line 138 "HexDLParser.hpp"
   ...
   enum yytokentype {
    ...
    HexDLParser (dlvhex::dl::HexDLDriver& driver_yyarg, dlvhex::dl::DLAtomInput& dlinput_yyarg);
    virtual ~HexDLParser ();
